...
public final class JsonKey {
  ...
  public static final String ACCOUNT_DELETE_TEMPLATE_ID = "deleteUserAccountTemplate";
  public static final String ACCOUNT_DELETE_TEMPLATE_SMS = "deleteUserAccountTemplate";
