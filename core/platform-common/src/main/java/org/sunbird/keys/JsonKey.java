...
public final class JsonKey {
  ...
  public static final String ACCOUNT_DELETE_TEMPLATE_EMAIL_BODY = "deleteUserAccountTemplate";
  public static final String ACCOUNT_DELETE_TEMPLATE_EMAIL_ID = "deleteUserAccountTemplate";
